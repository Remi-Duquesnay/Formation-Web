...
if (epee == true || bouclier == true) { //Ecrivez entre les parenthèses les tests correspondants
...
if (bouclier == true && !casque) { //Ecrivez entre les parenthèses les tests correspondants
...
if (epee == true && bouclier == true && casque == true  ) { //Ecrivez entre les parenthèses les tests correspondants
    console.log("Victoire ! Vous avez terminé le donjon ! A vous les loot et la gloire");
    gloire = true;
} else if( !epee && bouclier == true && !casque) { //Ecrivez entre les parenthèses les tests correspondants
