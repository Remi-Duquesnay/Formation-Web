...
Flex & Responsive : Récupérez les fichiers index.html et style.css. Toutes les modifications seront à faire dans style.css uniquement. Jouez des orientations et de l'ordre des éléments. < header> et < footer> ont une hauteur fixe, les éléments contenus dans < main> doivent s'adapter à l'espace vertical libre.
